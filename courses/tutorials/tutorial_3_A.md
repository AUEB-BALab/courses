...
* Να εξηγήσετε γιατί η επανάληψη 'for' και η επανάληψε 'while' είναι ισοδύναμες,
...
* Συχνά θέλουμε να προσπελάσουμε όλα τα στοιχεία μια συλλογής όπως κάποιος
πίνακας, ή κάποιο αντικείμενο της ArrayList κλάσης. Τότε η java προσφέρει ένα
κομψό τρόπο χωρίς τον ρητό ορισμό δεκτών ή συνθηκών του μήκους της συλλογής.
...
που βρίσκονται στη συλλογη εκτος κι αν υπαρξει εντολη εξόδου (return, break) ή
κάποιο σφάλμα.
...
Να γράψετε πρόγραμμα που να υπολογίζει τη σειρά Σ(1/n!)
για 100 πρώτους όρους και ύστερα για 1000. Ποια τιμή προσεγγίζει
η σειρά;
...
52 κανένα. Μπορείτε να το γράψετε με αναδρομή;
