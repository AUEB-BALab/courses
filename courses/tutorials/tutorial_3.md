...
* Είναι τύπος προγραμματισμού βασισμένο σε αντικείμενα (objects) που μοντελοποιούν
...
Η μεταβλητη του object (η foo στο παράδειγμα) δεν περιέχει όλη την πληροφορία της κατάστασής του
